...
-   Carbuccia, L. ; Heim, A. ; Barone, C. & Chevallier, C. (2025) [A randomised controlled trial on the effect of administrative burden and information costs on social inequalities in early childcare access in France](https://www.nature.com/articles/s41562-025-02293-4)
    ...
    -   "Multi-arm RCT in the Paris region measuring the effects of providing information and administrative support to pregnant women to access formal childcare. While increasing registration to formal childcare for low SES households, only high-SES households have higher access to daycare centres.
        ...
        -   [Pre-print and replication material](https://osf.io/preprints/osf/w2ey7_v5)
        -   [Pre-registration](https://www.socialscienceregistry.org/trials/9901)
        -   [Blog post](https://arthurheim.github.io/Home/Blog/posts/RandR_29042025.html)
:::
...
::: {.callout-tip}
## New version !
-   Heim (2025) [Welfare to What ?](https://osf.io/y8stq) "Welfare to what ? Experimental evaluation of an activation programme for single mothers in poverty in France")
