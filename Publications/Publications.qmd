...
-   Combe, J. & Heim, A. (2024) [Rage against the Matching: Fairness and inequalities in a market design experiment in France](https://www.dropbox.com/scl/fi/7r9c1lglfu04naqnbad4c/CombeHeim2024.pdf?rlkey=44rkwhus5nwj9kjq0gn0l4w9b&dl=0 "Rage against the Matching: Fairness and inequalities in a market design experiment in France"), in *Social investment & the changing face of poverty: Essays on the design & Evaluation of family policies in France*, PhD Thesis, EHESS, 2024. English.
    ...
    -   Definition and implementation of market design solutions to define assignment mechanisms for the daycare market in a field experiment in France.
...
-   Carbuccia, L. Heim, A. Barone, C. & Chevalier, C. (2024) [Investigating how administrative burden and search costs affect social inequalities in early childcare access, a randomised controled trial](https://osf.io/rh7eb/?view_only=ef7409ac646544eaac946374de134892), **Revise & Resubmit**, *Nature Human Behaviour*.
    ...
    -   "Multi-arm RCT in the Paris region measuring the effects of providing information and administrative support to pregnant women to access formal childcare increases social inequalities in access to daycare centres.
...
-   Heim (2024) [Welfare to What ?](https://www.dropbox.com/scl/fi/8jmyo6vvo4sk8o2ru09tw/Heim2024.pdf?rlkey=3cq7y8o84npws5cmdm2pgfsbx&dl=0 "Welfare to what ? Experimental evaluation of an activation programme for single mothers in poverty in France"), submitted to *European Economic Review*.

    -   A Randomised experiment of an intensive welfare-to-work programme targetting single parents on long-term welfare in France shows no effect on labour market participation and poverty after the end of the programme.
