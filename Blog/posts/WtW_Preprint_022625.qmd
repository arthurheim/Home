...
I’m pleased to share a new preprint now submitted to the *European Economic Review*:
...
* **Selection bias matters**: Standard difference-in-differences models using rich covariates failed to recover experimental estimates. Non-experimental evaluations would have erroneously concluded the programme worked.
* **No effects during or after COVID**: Treatment effects were consistent across cohorts, with no evidence that the pandemic distorted the findings.
