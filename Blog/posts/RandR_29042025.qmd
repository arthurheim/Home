...
description: "This paper, co-authored with Laudine Carbuccia, Coralie Chevallier, and Carlo Barone, uses a three-arm randomized controlled trial to test interventions aimed at increasing applications to formal childcare in France. 
We uncover the cognitive, procedural, and structural barriers that contribute to persistent inequalities in access. Here’s what we found."
author:
  - name: Arthur Heim
date: 04-29-2025
...
We are thrilled to announce that our paper, *Investigating how administrative burden and information costs affect social inequalities in early childcare access*, has been accepted for publication in *Nature Human Behaviour*.
...
2. **Information-only group**: Received videos and reminders about early childcare options, costs, and how to apply.
...
* **Information alone did not increase application or access rates.**
...
* **Cognitive and behavioural barriers**, such as low procedural knowledge, choice overload, and psychological costs, *can be addressed* with low-touch, scalable interventions.
* But **structural barriers**, such as opaque prioritization criteria, discretionary selection, and potential discrimination, *persist even after application barriers are removed*.
